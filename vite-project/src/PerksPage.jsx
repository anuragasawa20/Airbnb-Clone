...
export default function Perks({ selected, onChange }) {
    ...
    return (
        <>
            <label className="flex border  px-4  py-8 rounded-2xl mx-1 gap-2 items-center  cursor-pointer">
            ...
            <label className="flex border  p-4 rounded-2xl mx-1 gap-2 items-center  cursor-pointer">
